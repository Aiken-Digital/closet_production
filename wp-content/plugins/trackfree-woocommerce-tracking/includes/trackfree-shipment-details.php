    ...
    if ($track_details_length > 0) {
        if ($track_details_length > 3) {
            ...
            <div class="shipment-container" id="shipment_container_<?php echo $row;?>" style="<?php echo $style;?>">
                ...
                <a href="javascript:void(0);"><input type="button" class="<?php echo $type;?>-btn-show-more button action" id="<?php echo $type;?>-btn-show-more_<?php echo $row;?>" value="<?php _e('See all shipping activity', 'trackfree-woocommerce-tracking');?>" style="margin-bottom: 5px;"/></a>
        ...
        <table style="width: 100%;">
            <tr>
                <td><?php _e('No track details available', 'trackfree-woocommerce-tracking');?></td>
            </tr>
        </table>
        <?php
    }
