  ...
  <div class="feature-section one-col">
    <div class="col">
      ...
      <p><a href="<?php echo $this->pro_url; ?>" target="_blank" class="wow-btn">Get Pro Version</a></p>
			...
			<p><a href="https://wow-estore.com/demo/wow-modal-window-pro/" target="_blank" class="wow-btn-demo">Demo Pro Version</a></p>
      ...
      <p>ADDITIONAL OPTIONS IN PRO VERSION:</p>
        ...
        <div class="inside" style="display: none;">
          <p>Adding animation to the appearance and disappearance of a modal window</p>          
				</div>
			</div>
			...
			<div class="items itembox">	
				...
				<div class="inside" style="display: none;">
					<p>More fine-tuning the style for the modal window and the close button will help create various pop-up blocks on the site for any purpose.</p>
				</div>
			</div>
