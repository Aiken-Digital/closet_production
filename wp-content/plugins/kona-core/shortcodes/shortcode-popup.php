...
$options = array(
	...
	array( "name" => esc_html__("Accordion", 'kona'),
		   "desc" => "",
		   "id" => "accordion",
		   "type" => "sectionstart"
		  ),
			...
			array( "name" => "Group",
				...
				array( "name" => esc_html__("Open", 'kona'),
					   "desc" => "",
			...
			array( "name" => esc_html__("Add Accordion", 'kona'),
	...
	array( "name" => esc_html__("Alert", 'kona'),
		   "desc" => "",
		   "id" => "alert",
		   "type" => "sectionstart"
		  ),
		  
		  	array( "name" => esc_html__("Alert type", 'kona'),
				   "desc" => "",
				   "id" => $sc."_alerttype",
				   "type" => "selectbox",
				   "option" => array( 
						array(	"name" => esc_html__("Info", 'kona'), 
							  	"value" => "info"),
						array(	"name" => esc_html__("Confirm", 'kona'), 
							  	"value" => "confirm"),		
						array(	"name" => esc_html__("Error", 'kona'), 
							  	"value"=> "error")
						)
				  ),
				  
			array("name" => esc_html__("Alert Title", 'kona'),
					"desc" => "",
					"id" => $sc."_alerttitle",
					"type" => "text"
					),
					
			array("name" => esc_html__("Alert Text", 'kona'),
					"desc" => "",
					"id" => $sc."_alerttext",
					"type" => "textarea"
					),	
	...
	array( "name" => esc_html__("Button", 'kona'),
		   ...
		   "type" => "sectionstart"
		  	...
		  	array( "name" => esc_html__("Button Type", 'kona'),
				   "desc" => "",
				   "id" => $sc."_buttontype",
				   "type" => "selectbox-hiding",
				   "option" => array( 
						array(	"name" => esc_html__("Text Button (default)", 'kona'), 
							  	"value" => "text"),
						array(	"name" => esc_html__("Arrow Button", 'kona'), 
							  	"value"=> "arrow"),
						array(	"name" => esc_html__("Icon Button", 'kona'), 
							  	"value"=> "icon"),
						
						)
				  ),
					  
			  	array(	"name" => esc_html__("Button Text", 'kona'),
						"desc" => "",
						"id" => $sc."_buttontext",
						"type" => "text"
						),
				...
				array( "name" => "Hidinggroup",
					   ...
					   "type" => "hidinggroupstart"
					 	...
					 	array( "name" => esc_html__("Arrow / Icon Position", 'kona'),
							   "desc" => "",
							   "id" => $sc."_buttoniconpos",
							   "type" => "selectbox",
							   "option" => array( 
				...
				array( "name" => "Hidinggroup",
					   ...
					   "type" => "hidinggroupstart"
					 	...
					 	array( "name" => esc_html__("Choose Icon", 'kona'),
							   "desc" => "",
							   "id" => $sc."_buttonicon",
							   "type" => "icons"
							  ),  		
				...
				array( "name" => esc_html__("Button Size", 'kona'),
					   "desc" => "",
					   "id" => $sc."_buttonsize",
					   "type" => "selectbox",
					   "option" => array( 
			...
			array( "name" => esc_html__("Button Style", 'kona'),
				   "desc" => "",
				   "id" => $sc."_buttonstyle",
				   "type" => "selectbox-hiding",
				   "option" => array(
						array(	"name" => esc_html__("Dark Button", 'kona'), 
								"value" => "style-1"),
						array(	"name" => esc_html__("White Button", 'kona'), 
								"value" => "style-2"),
						array(	"name" => esc_html__("Grey Button", 'kona'), 
								"value" => "style-3"),
						array(	"name" => esc_html__("Underline Button", 'kona'), 
								"value" => "style-4")
						)
				  ),
				...
				array( "name" => "Hidinggroup",
					   "id" => $sc."_buttonstyle",
					   "hiding" => "style-1 style-2 style-3",
					   "type" => "hidinggroupstart"
					  ),
					 	
					array( "name" => esc_html__("Text Transparent", 'kona'),
						   "desc" => "",
						   "id" => $sc."_buttontransparent",
						   "type" => "selectbox",
						   "option" => array(
			...
			array( "name" => esc_html__("Linkt To", 'kona'),
				   "desc" => "What should the button open?",
				   "id" => $sc."_buttongoto",
				   "type" => "selectbox-hiding",
				   "option" => array( 
						...
						array(	"name" => esc_html__("Page", 'kona'), 
							  	"value"=> "page"),
						array(	"name" => esc_html__("Portfolio item", 'kona'), 
							  	"value"=> "portfolio"),
						array(	"name" => esc_html__("Product item", 'kona'), 
							  	"value"=> "product"),
						array(	"name" => esc_html__("Lightbox Image", 'kona'), 
							  	"value"=> "image"),
						array(	"name" => esc_html__("Lightbox Video (youtube)", 'kona'), 
							  	"value"=> "youtube"),
						array(	"name" => esc_html__("Lightbox Video (vimeo)", 'kona'), 
							  	"value"=> "vimeo"),
						array(	"name" => esc_html__("Lightbox Video (selfhosted/mp4)", 'kona'), 
							  	"value"=> "selfhosted")	
						)
				  ),
			...
			array( "name" => "Hidinggroup",
				...
				array( "name" => esc_html__("Button URL", 'kona'),
					   "desc" => "",
					   "id" => $sc."_button_url_url",
					   "type" => "text"
					  ),	  
				  
				array( "name" => esc_html__("Button Target", 'kona'),
					   "desc" => "",
			...
			array( "name" => "Hidinggroup",
				...
				array( "name" => esc_html__("Select Page", 'kona'),
					   "desc" => "",
					   "id" => $sc."_button_page",
					   "type" => "pages"
					  ),		  
			...
			array( "name" => "Hidinggroup",
				...
				array( "name" => esc_html__("Select Portfolio Item", 'kona'),
					   "desc" => "",
			...
			array( "name" => "Hidinggroup",
				...
				array( "name" => esc_html__("Select Product Item", 'kona'),
					   "desc" => "",
					   "id" => $sc."_button_product",
					   "type" => "product"
					  ),		  
			...
			array( "name" => "Hidinggroup",
				...
				array( "name" => esc_html__("Choose Image", 'kona'),
					   "desc" => "",
			...
			array( "name" => "Hidinggroup",
				...
				array( "name" => esc_html__("Video ID", 'kona'),
					   "desc" => "Enter your youtube or vimeo ID",
					   "id" => $sc."_button_video_id",
					   "type" => "text"
					  ),
			...
			array( "name" => "Hidinggroup",
				...
				array( "name" => esc_html__("Video File", 'kona'),
	...
	array( "name" => esc_html__("Buttons", 'kona'),
		   	"id" => "buttons",
		    "type" => "sectionend"),
	...
	array( "name" => esc_html__("Icon", 'kona'),
		   ...
		   "type" => "sectionstart"
			...
			array( "name" => esc_html__("Size", 'kona'),
				   "desc" => '',
				   "id" => $sc."_iconsize",
				   "type" => "selectbox",
				   "option" => array(			 	
			...
			array( 	"name" => esc_html__("Color", 'kona'),
					"desc" => "",
					"id" => $sc."_iconcolor",
					"type" => "color"
				  	),
	...
	array( "name" => esc_html__("Quote Slider", 'kona'),
		   "desc" => "",
		   "id" => "quoteslider",
		   "type" => "sectionstart"
		  ),
			...
			array( "name" => "Group",
				...
				array( "name" => esc_html__("Quote", 'kona'),
					   "desc" => "",
					   "id" => $sc."_quotetext",
					   "type" => "textarea"
					  ),			
				
				array( "name" => esc_html__("Cite (optional)", 'kona'),
				   	   "desc" => "",
					   "id" => $sc."_quotecite",
					   "type" => "text"
					  ),
			...
			array( "name" => esc_html__("Add Quote", 'kona'),
	...
	array( "name" => esc_html__("Spacer / Margin", 'kona'),
		   "desc" => "",
		   "id" => "spacer",
		   "type" => "sectionstart"
		  ),
	...
	array( "name" => esc_html__("Spacer", 'kona'),
		   "id" => "spacer",
		   "type" => "sectionend"
		  ),	
		  
	
	array( "name" => esc_html__("Tabs", 'kona'),
		   "desc" => "",
		   "id" => "tab",
		   "type" => "sectionstart"
		  ),
		  
		  	array( "name" => esc_html__("Tab Style", 'kona'),
				   "desc" => "",
				   "id" => $sc."_tabstyle",
				   "type" => "selectbox",
				   "option" => array( 
						array(	"name" =>"Standard Tabs", 
								"value" => "standard"),
						array(	"name" =>"Button Style", 
								"value" => "button")
						)
				  ),
			...
			array( "name" => "Group",
				...
				array( "name" => esc_html__("Tab Name", 'kona'),
				   	   "desc" => "",
					   "id" => $sc."_tabname",
					   "type" => "text"
					  ),
				
				array( "name" => esc_html__("Tab Text", 'kona'),
					   "desc" => "",
					   "id" => $sc."_tabtext",
					   "type" => "textarea"
					  ),
			...
			array( "name" => esc_html__("Add Tab", 'kona'),
	...
	array( "name" => esc_html__("Toggle", 'kona'),
		   "desc" => "",
		   "id" => "toggle",
		   "type" => "sectionstart"
		  ),
			...
			array( "name" => esc_html__("Toggle Open", 'kona'),
				   "desc" => "",
				   "id" => $sc."_toggleopen",
				   "type" => "selectbox",
				   "option" => array( 
			...
			array( "name" => esc_html__("Toggle Title", 'kona'),
				   "desc" => "",
				   "id" => $sc."_toggletitle",
				   "type" => "text"
				  ),
			
			array( "name" => esc_html__("Toggle Text", 'kona'),
				   "desc" => "",
				   "id" => $sc."_toggletext",
				   "type" => "textarea"
				  ),
	...
	array( "name" => esc_html__("Subtitle", 'kona'),
		   ...
		   "type" => "sectionstart"
			...
			array( "name" => "",
				   "desc" => "This will use the subtitle font you choosed in the theme options.",
				   "id" => $sc."_subtitle_info",
				   "type" => "infotext"
				  ),
				  
			array( "name" => esc_html__("Title Name", 'kona'),
				   "desc" => "",
			...
			array( "name" => esc_html__("Title Alignment", 'kona'),
					"desc" => "",
					"id" => $sc."_subtitle_alignment",
					"type" => "selectbox",
					"option" => array(			 	
						array(	"name" =>"Left", "value" => "auto"),
						array(	"name" =>"Center", "value" => "center"),
						array(	"name" =>"Right", "value" => "right")
						)
				  ),	
				  
			array( "name" => esc_html__("Uppercase", 'kona'),
					"desc" => "",
					"id" => $sc."_subtitle_uppercase",
					"type" => "selectbox",
					"option" => array(			 	
	...
	array( "name" => esc_html__("Video", 'kona'),
		   "desc" => "",
		   "id" => "video",
		   "type" => "sectionstart"
		  ),
		  
		  array( "name" => esc_html__("Video Type", 'kona'),
				   "desc" => "",
				   "id" => $sc."_videotype",
				   "type" => "selectbox-hiding",
				   "option" => array( 
						array(	"name" => esc_html__("Inline Video", 'kona'), 
							  	"value" => "inline"),
						array(	"name" => esc_html__("Lightbox", 'kona'), 
							  	"value"=> "lightbox")	
						)
				  ),
			
				array( "name" => "",
					   "desc" => "A inline video will display a placeholder image with play button.",
					   "id" => "",
					   "type" => "infotext"
					  ),
					  
				array( "name" => esc_html__("Placeholder Image", 'kona'),
					   "desc" => "",
					   "id" => $sc."_video_inline_image",
					   "type" => "image"
					  ),	
					  
				array( "name" => esc_html__("Youtube or Vimeo", 'kona'),
					   "desc" => "",
...
<!--style-->
<link rel="stylesheet" href="<?php echo esc_url(plugins_url( '/css/shortcodes-style.css?ver=1.0.0', __FILE__ )); ?>" />
<link rel="stylesheet" href="<?php echo esc_url(get_template_directory_uri() . '/files/'); ?>css/font-awesome.min.css?ver=4.3.0" />
<link rel="stylesheet" href="<?php echo esc_url(get_template_directory_uri() . '/files/'); ?>css/ionicons.css" />

<!--scripts-->
<script src="<?php echo plugins_url( '/js/shortcode-function.js', __FILE__ ); /* esc_url stripped because of issue on server (kona) */ ?>"></script>
...
<div id="shortcodes">
    ...
    <div class="sc_option">
        ...
        foreach ($options as $option) {
			...
			//sectionend
			case "sectionend":
				echo '	<a href="" id="insert_'.$option['id'].'" class="submit">'.esc_html__("Insert", 'kona').'</a> 
						</form>
						</div>';
			break;
			...
			case "hidinggroupstart":
				...
				echo '	<div id="'.$option['id'].'" class="group hidinggroup hide'.$option['id'].' '.$hideClass.'">';
			break;
			...
			case "image":
				echo '<div id="'.$option['id'].'" class="sc-option clear">';
					...
					echo '	<div class="sc-option-value single-image">
								<span class="preview-image"><img src="" /></span>
								<input type="text" name="'.$option['id'].'" id="'.$option['id'].'" value="" style="display:none;" />
								<a href="#" class="upload-sc-image">'.esc_html__('Add Image', 'kona').'</a>
								<a href="#" class="remove-sc-image" style="display: none;">' . esc_html__('Remove Image', 'kona') . '</a>
							</div>';
				echo '</div>';
			break;
			...
			case "video":
				echo '<div id="'.$option['id'].'" class="sc-option clear">';
					...
					echo '	<div class="sc-option-value single-image">
								...
								<a href="#" class="upload-sc-video">'.esc_html__('Add Video', 'kona').'</a>
								<a href="#" class="remove-sc-video" style="display: none;">' . esc_html__('Remove Video', 'kona') . '</a>
							</div>';
				echo '</div>';
			break;
			...
			case "audio":
				echo '<div id="'.$option['id'].'" class="sc-option clear">';
					...
					echo '	<div class="sc-option-value single-image">
								<input type="text" name="'.$option['id'].'" id="'.$option['id'].'" value=""/>
								<a href="#" class="upload-sc-audio">'.esc_html__('Add Audio', 'kona').'</a>
								<a href="#" class="remove-sc-audio" style="display: none;">' . esc_html__('Remove Audio', 'kona') . '</a>
							</div>';
				echo '</div>';
			break;
			...
			case 'medias':  
				echo '<div id="'.$option['id'].'" class="sc-option clear">';
					...
					echo '	<input class="add_image button" type="button" value="'.esc_html__("Add Images", 'kona').'" />
