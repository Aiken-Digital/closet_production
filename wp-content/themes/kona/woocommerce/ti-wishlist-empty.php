...
<div class="tinv-wishlist woocommerce notfound">
	...
	<p class="return-to-shop">
		<a class="sr-button-text wc-backward" href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>"><?php esc_html_e( '[:jp]ショップへ戻る[:en]Return To Shop', 'kona' ); ?></a>
	</p>
</div>