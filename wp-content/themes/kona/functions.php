...
if( !function_exists( 'kona_enqueue_scripts' ) ) {
    function kona_enqueue_scripts() {
    	...
    	wp_enqueue_script('zoom', get_template_directory_uri() . '/files/js/jquery.zoom.min.js', array('jquery'), '1.7.21', true);
    		//vendors
    	wp_enqueue_script('carousel', get_template_directory_uri() . '/files/js/slick.min.js', array('jquery'), true);
    		//app js
    	wp_enqueue_script('app-script', get_template_directory_uri() . '/files/js/app.js', array('jquery'), true);
		...
		wp_enqueue_style('flickity', get_template_directory_uri() . '/files/css/flickity.css', 'flickity-style', '2.0.11');
			//ventors
		wp_enqueue_style('bootstrap-style', get_template_directory_uri() . '/files/css/bootstrap-grid.min.css', 'bootstrap-grid');
		wp_enqueue_style('carousel-slick', get_template_directory_uri() . '/files/css/slick.css', 'slick-theme');
		wp_enqueue_style('carousel-slick', get_template_directory_uri() . '/files/css/slick-theme.css', 'slick-theme');
			//custom styles
		wp_enqueue_style('custom-style', get_template_directory_uri() . '/files/css/app.css', 'custom-style');
